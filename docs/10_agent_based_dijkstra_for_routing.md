...
defmodule AII.Routing.AgentBasedDijkstra do
  ...
  # Main Dijkstra workflow
  defworkflow DijkstraRouting do
    @doc """
  ...
  # Dijkstra iteration playlist
  defplaylist DijkstraIteration do
    ...
    record :update_nodes, UpdateNodeStates
